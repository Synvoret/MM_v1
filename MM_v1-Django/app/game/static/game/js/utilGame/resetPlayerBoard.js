function resetPlayerBoard() {
    ...
    document.getElementById("fierce-loyality-loyality-track").setAttribute('href', '');
    document.getElementById("happy-loyality-track").setAttribute('href', '');
    document.getElementById("pleased-loyality-track").setAttribute('href', '');
    document.getElementById("content-loyality-track").setAttribute('href', '');
    document.getElementById("restless-loyality-track").setAttribute('href', '');
    document.getElementById("unhappy-loyality-track").setAttribute('href', '');
    document.getElementById("angry-loyality-track").setAttribute('href', '');
    document.getElementById("mutiny-loyality-track").setAttribute('href', '');
    ...
    document.getElementById("player-hit-location-image").setAttribute('href', '');
